...
public class SingleRecipeActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                Intent intent = new Intent(SingleRecipeActivity.this, ViewActivity.class);
    ...
    private void showStatusPopup(final Activity context, Point p) {
        ...
        LinearLayout viewGroup = (LinearLayout) context.findViewById(R.id.KcalPopup);
        ...
        final GestioneDB db = new GestioneDB(SingleRecipeActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int indexOfRecipe = this_intent.getIntExtra("recipeIndex", 0);
        ...
        btnZip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(SingleRecipeActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_CODE);
        ...
        imgValNutrizionali.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
                ...
                showStatusPopup(SingleRecipeActivity.this, point);
       ...
       // getSupportActionBar().setTitle("Ricetta scelta per te");
        ...
        Cursor mCursor = db.ottieniRicetta(indexOfRecipe);

        int recipeId = indexOfRecipe;
        ...
        mCursor = db.ottieniFoto(recipeId);
            ...
            if(mCursor != null && mCursor.moveToFirst()) {
                ...
                for(int i = 0; i < cursorSize; i++){
                    ...
                    if(immagine.equals("") && i == 1) {
                        LinearLayout layoutImg = (LinearLayout) findViewById(R.id.imageLayout2);
    ...
    private File addFilesToZip() {
        ...
        fileName = recipeName + ".zip";
              ...
              /*  final Bitmap selectedImage1 = StringToBitMap(img1);
                Log.d("bitmap to zip", " "+ selectedImage1);
                final Bitmap selectedImage2 = StringToBitMap(img2);
                final Bitmap selectedImage3 = StringToBitMap(img3);*/
